...
import { CancelOrderRequest, OrderRequest, OrderResponse, OrderType } from '../types/index';
...
export class CustomOperations {
  ...
  private async getSlippagePrice(symbol: string, isBuy: boolean, slippage: number, px?: number): Promise<number> {
