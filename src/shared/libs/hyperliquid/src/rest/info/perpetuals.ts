...
export class PerpetualsInfoAPI {
  ...
  async getMeta(rawResponse: boolean = false): Promise<any> {
  ...
  async getUserFunding(user: string, startTime: number, endTime?: number, rawResponse: boolean = false): Promise<any> {
    const response = await this.httpApi.makeRequest(
      {
  ...
  async getPredictedFundings(rawResponse: boolean = false): Promise<any> {
    const response = await this.httpApi.makeRequest(
      {
  ...
  async getPerpsAtOpenInterestCap(rawResponse: boolean = false): Promise<any> {
    const response = (await this.httpApi.makeRequest({
