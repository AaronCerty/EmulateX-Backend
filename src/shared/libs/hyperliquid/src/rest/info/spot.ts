import { SpotClearinghouseState, SpotMeta, SpotMetaAndAssetCtxs } from '../../types';
...
export class SpotInfoAPI {
  ...
  async getSpotMeta(rawResponse: boolean = false): Promise<any> {
  ...
  async getSpotClearinghouseState(user: string, rawResponse: boolean = false): Promise<any> {
