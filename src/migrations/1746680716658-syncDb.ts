...
export class SyncDb1746680716658 implements MigrationInterface {
  name = 'SyncDb1746680716658';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."withdraw_history_status_enum" AS ENUM('PENDING_HYPERLIQUID', 'PENDING_BLOCKCHAIN', 'COMPLETED', 'FAILED')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."withdraw_history_status_enum_old" AS ENUM('PENDING_HYPERLIQUID', 'PENDING_SMART_CONTRACT', 'COMPLETED', 'FAILED')`,
    );
    await queryRunner.query(
